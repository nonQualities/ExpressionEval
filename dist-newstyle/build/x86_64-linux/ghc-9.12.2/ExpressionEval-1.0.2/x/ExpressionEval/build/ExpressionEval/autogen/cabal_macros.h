...
/* package ExpressionEval-1.0.2 */
#ifndef VERSION_ExpressionEval
#define VERSION_ExpressionEval "1.0.2"
#endif /* VERSION_ExpressionEval */
#ifndef MIN_VERSION_ExpressionEval
#define MIN_VERSION_ExpressionEval(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 2)
#endif /* MIN_VERSION_ExpressionEval */
...
#define CURRENT_COMPONENT_ID "ExpressionEval-1.0.2-inplace-ExpressionEval"
